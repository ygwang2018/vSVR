...
read.libsvm = function( filename, dimensionality ) {
  ...
  yx=cbind(yx[,2:(dimensionality+1)],yx[,1])
  
  return( yx )
}


DataSet = read.libsvm( "C:/Users/n10141065/Queensland University of Technology/You-Gan Wang - RyanWu(Jinran)/TNNLS Revised/TNNLS revised iii/Case/nucase_chosen/bodyfat.txt", dimensionality=14 )
...
write.csv(CV_Results,"C:/Users/n10141065/Queensland University of Technology/You-Gan Wang - RyanWu(Jinran)/TNNLS Revised/TNNLS revised iii/Case/nucase_chosen/bodyfat_nucv.csv")
...
Results<-rbind(CV_Results,LinResults,MaResults)

write.csv(Results,"benchmark_results.csv")
