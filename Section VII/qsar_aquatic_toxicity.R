...
DataSet<-read.csv('C:/Users/n10141065/Queensland University of Technology/You-Gan Wang - RyanWu(Jinran)/TNNLS Revised/TNNLS revised iii/Case/nucase_chosen/qsar_aquatic_toxicity.csv')
...
mean(CV_Results[2,])
sd(CV_Results[2,])
write.csv(CV_Results,"C:/Users/n10141065/Queensland University of Technology/You-Gan Wang - RyanWu(Jinran)/TNNLS Revised/TNNLS revised iii/Case/nucase_chosen/qsar_aquatic_toxicity_nucv.csv")
#####Lin
