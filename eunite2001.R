...
DataSet<-read.csv('C:/Users/n10141065/Queensland University of Technology/You-Gan Wang - RyanWu(Jinran)/TNNLS Revised/TNNLS revised iii/Case/nucase_chosen/eunite2001.csv')
...
InputScale<-(DataSet1[,1:(ResponseIndex-1)])  
...
write.csv(CV_Results,"C:/Users/n10141065/Queensland University of Technology/You-Gan Wang - RyanWu(Jinran)/TNNLS Revised/TNNLS revised iii/Case/nucase_chosen/eunite2001_nucv.csv")
